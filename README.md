...
A modern personal portfolio showcasing my work in **Web3, Blockchain, Rust, and AI/ML**, built with a clean frontend stack and deployed on **Vercel**.

---

## Tech Stack
- **Frontend:** React.js / Next.js, Tailwind CSS, JavaScript  
- **Web3:** Ethereum, Solidity, Web3.js, Ethers.js, Hardhat  
- **Systems:** Rust, Tokio, Serde  
- **Tools:** Git, GitHub, Docker, VS Code, npm  
- **AI/ML:** Prompt Engineering, NLP, ML Model Deployment  
